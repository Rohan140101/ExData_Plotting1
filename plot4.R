...
plot(x = date_and_time,y = table2$Global_active_power,xlab = "",ylab = "Global Active Power (kilowatts)",type = "l")

plot(x = date_and_time,y = table2$Voltage,xlab = "datetime",ylab = "Voltage",type = "l")
...
plot(x = date_and_time,y = table2$Global_reactive_power,xlab = "datetime",ylab = "Global Reactive Power",type = "l")
dev.off()